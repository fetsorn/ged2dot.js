...
export function graph_find(graph, identifier) {
  if (!identifier) {
    return null;
  }
  var results = [];
...
export function graph_find_(graph) {
  for (var i in graph) {
    var node = graph[i];
